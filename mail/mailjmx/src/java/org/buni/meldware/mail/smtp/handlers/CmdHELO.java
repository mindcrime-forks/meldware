...
/**
 * HELO and EHLO are basically equivilent.  One signifies a server which has extended SMTP
 * capabilities.  Primarily, authentication/etc.  This is the handshake that begins the session.
 * 
 * @author Andrew C. Oliver
 * @version $Revision: 1.3 $
 */
public class CmdHELO implements SMTPHandler, SMTPConstants {

    private static final Logger jblog = Logger.getLogger(CmdHELO.class);

    public final static String COMMAND = "HELO";
    ...
    /**
     * @param iter containing a list or the argument lines (which SMTP doesn't do anyhow)
