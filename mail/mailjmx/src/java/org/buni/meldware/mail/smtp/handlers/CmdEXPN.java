...
/**
 * EXPN command, recommended by <a href='http://www.faqs.org/ftp/rfc/pdf/rfc2821.txt.pdf'>rfc 2821</a>
 *
 * @author Kabir Khan
 * @version $Revision: 1.3 $
 */
public class CmdEXPN implements SMTPHandler, SMTPConstants {

    private static final Logger jblog = Logger.getLogger(CmdEXPN.class);

    public final static String COMMAND = "EXPN";

    public SMTPResponse handleRequest(OutputStream out, SMTPRequest request,
            SMTPProtocolInstance protocol) throws IOException {
        jblog.debug("EXPN command handler called");
