...
/**
 * APOP alternative authentication mechanism.
 *
 * @author Eric Daugherty
 * @author Andrew C. Oliver
 */
public class CmdAPOP extends AbstractCommand implements POP3Handler {

    public final static String COMMAND = "APOP";
    ...
    public POP3Response handleRequest(OutputStream out, POP3Request request,
        ...
        log.debug("APOP command handler called");
        ...
        if (verifyState(protocol, writer,
            ...
            UserRepository ur = protocol.getAOPUserRepostiory();
            String apopId = protocol.getApopId();
            if (!ur.test(username, password, apopId)) {
                ...
                try {
                    ...
                    // If the mailbox is null here, something is wrong since we
