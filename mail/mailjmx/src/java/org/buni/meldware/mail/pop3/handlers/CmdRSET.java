...
/**
 * RSET unmarks any messages that
 * have been marked for deletion.
 *
 * @author Eric Daugherty
 * @version $Revision: 1.3 $
 */
public class CmdRSET extends AbstractCommand implements POP3Handler {

    public final static String COMMAND = "RSET";

    /** Log4j logger */
    private static final Logger log = Logger.getLogger(CmdRSET.class);
    ...
    public POP3Response handleRequest(OutputStream out, POP3Request request,
        ...
        log.debug("RSET command handler called");
        ...
        if (verifyState(protocol, writer,
            ...
            folder.setDeleted(true, Range.ALL, false);
