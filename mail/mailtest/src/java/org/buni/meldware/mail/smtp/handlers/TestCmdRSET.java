 ...
 * @author Kabir Khan
 */
public class TestCmdRSET extends HandlerBase {

    public static TestSuite suite() {
        return JMXTestWrapper.suite(TestCmdRSET.class);
    }
    
    public TestCmdRSET(String name){
        super(name);
    }

    public static void main(String[] args) {
        junit.textui.TestRunner.run(TestCmdRSET.class);
    }
