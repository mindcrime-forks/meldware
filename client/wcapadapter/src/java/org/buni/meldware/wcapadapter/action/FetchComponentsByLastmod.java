...
public class FetchComponentsByLastmod extends WCAPSessionAction {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if(componentType.equals(COMPONENT_TYPE_ALL)||componentType.equals(COMPONENT_TYPE_EVENT))
		{
            ...
            if (queryForm.getDtstart().equals("0")) {
                queryForm.setDtstart("19700101T040000Z");
            }
			...
			Invite[] invites = pim.listInvitesByLastMod(startDate, endDate); 
