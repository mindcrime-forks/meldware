...
//    import org.buni.meldware.admin.controller.ServiceEvent;
    ...
    public class EditServiceCommand extends SequenceCommand implements Command, Responder {

        private var model : ModelLocator = ModelLocator.getInstance();
       
        override public function execute( event : CairngormEvent ) : void {
            trace("in EditServiceCommand execute");
            
            var delegate : ServiceDelegate = new ServiceDelegate( this );   
            delegate.editService( event.data );          
        }
       ...
       public function onResult( event : * = null ) : void {            
           if (event.result.status != null) {
              ...
              var e:CairngormEvent = new CairngormEvent(AdminController.SERVICE_EDITED);
