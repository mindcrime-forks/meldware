...
//    import org.buni.meldware.admin.controller.ServiceEvent;
    ...
    public class AddThreadPoolCommand extends SequenceCommand implements Command, Responder {

        private var model : ModelLocator = ModelLocator.getInstance();
       
        override public function execute( event : CairngormEvent ) : void {
            trace("in AddThreadPoolCommand execute");
            
            var delegate : ThreadPoolDelegate = new ThreadPoolDelegate( this );   
            delegate.addThreadPool( event.data );          
        }
       ...
       public function onResult( event : * = null ) : void {            
           if (event.result.status != null) {
              ...
              var e:CairngormEvent = new CairngormEvent(AdminController.THREADPOOL_ADDED);
