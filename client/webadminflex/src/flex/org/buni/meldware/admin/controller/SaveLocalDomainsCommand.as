...
//    import org.buni.meldware.admin.controller.ServiceEvent;
    ...
    public class SaveLocalDomainsCommand extends SequenceCommand implements Command, Responder {

        private var model : ModelLocator = ModelLocator.getInstance();
       
        override public function execute( event : CairngormEvent ) : void {
            trace("in SaveLocalDomainsCommand execute");
            
            var delegate : LocalDomainDelegate = new LocalDomainDelegate( this );   
            delegate.saveLocalDomains( model.postmaster, model.localdomains );          
        }
