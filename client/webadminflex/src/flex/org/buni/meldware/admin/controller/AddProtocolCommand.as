...
//    import org.buni.meldware.admin.controller.ServiceEvent;
    ...
    public class AddProtocolCommand extends SequenceCommand implements Command, Responder {

        private var model : ModelLocator = ModelLocator.getInstance();
       
        override public function execute( event : CairngormEvent ) : void {
            trace("in AddProtocolCommand execute");
            
            var delegate : ProtocolDelegate = new ProtocolDelegate( this );   
            delegate.addProtocol( event.data );          
        }
       ...
       public function onResult( event : * = null ) : void {            
           if (event.result.status != null) {
              ...
              var e:CairngormEvent = new CairngormEvent(AdminController.PROTOCOL_ADDED);
