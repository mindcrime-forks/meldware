package org.buni.meldware.admin.model
{
	...
	{	
		private var _id:String;   //flex UID = ldap UID.hashCode();
        ...
        public function AddressBookEntryVO(o:Object=null) {
        	...
        	//	this.realUid = ModelUtil.nvl(o,"uid");
        		this.cn = ModelUtil.nvl(o,"FullName");
        ...
        public function set username(theuid:String):void {
        	this._uid = theuid;
        }
        
        public function set cn(thecn:String):void {
        	this._cn = thecn;
        }
        
        public function get cn():String {
        	return this._cn;
        }
        
        public function set fullName(thecn:String):void {
        	this._cn = thecn;
        }
