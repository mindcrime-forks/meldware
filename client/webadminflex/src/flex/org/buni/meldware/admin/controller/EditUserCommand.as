...
//    import org.buni.meldware.admin.controller.ServiceEvent;
    ...
    public class EditUserCommand extends SequenceCommand implements Command, Responder {

        private var model : ModelLocator = ModelLocator.getInstance();
       
        override public function execute( event : CairngormEvent ) : void {
            trace("in EditUserCommand execute");
            
            var delegate : UserDelegate = new UserDelegate( this );   
            delegate.editUser( event.data );          
        }
       ...
       public function onResult( event : * = null ) : void {            
           if (event.result.status != null) {
              ...
              var e:CairngormEvent = new CairngormEvent(AdminController.USER_EDITED);
