...
public class UpdateEventCommand extends BaseCommand {
    ...
    public static final String COMMAND_NAME = "updateEvent";
    /**
     * @param sender
     */
    public UpdateEventCommand(MailSender sender) {
        super(sender);
    }
    /* (non-Javadoc)
    ...
    public String execute(HttpServletRequest request, PrintWriter out) {
        ...
        try {
            ...
            pim.updateEvent(event);
            out.println("<complete/>");
            return Command.SUCCESS;
        } catch (Exception e) {
            this.printError("Failed to update event", e, out);
