 ...
 *
 */
public class AddSharedContactCommand extends BaseCommand {
	
	public static final String COMMAND_NAME = "addSharedContact";

	/**
     * @param sender
     */
    public AddSharedContactCommand(MailSender sender) {
        super(sender);
    }
