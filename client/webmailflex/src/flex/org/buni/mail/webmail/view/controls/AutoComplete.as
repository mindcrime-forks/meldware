...
package org.buni.mail.webmail.view.controls
{
...
{
	private var _wasBackspace:Boolean;
	//--------------------------------------------------------------------------
	//
	//  Constructor
    //
	...
	public function set typedText(input:String):void
	{
	    ...
	    invalidateProperties();
		invalidateDisplayList();
		var e:CairngormEvent = new CairngormEvent("typedTextChange");
		e.data = _typedText;
		dispatchEvent(e);
	}
						      ...
						      unscaledHeight:Number):void
	{
	    ...
	    if(dropdown)
		{
		    if(typedTextChanged && !_wasBackspace)
			{
